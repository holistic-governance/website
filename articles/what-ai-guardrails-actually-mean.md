...
seoTitle: What AI Guardrails Actually Mean
date: 2026-07-30
...
topics: ai-governance-aged-care, ai-guardrails
---
...
**The policy landscape has churned — check currency before you cite it.** Australia's Voluntary AI Safety Standard, published in September 2024 with its ten voluntary guardrails, was superseded in October 2025 by the National AI Centre's Guidance for AI Adoption, built around six essential practices: decide who is accountable, understand impacts and plan accordingly, measure and manage risks, share essential information, test and monitor, and maintain human control. Notice what happened to the vocabulary: the current national guidance has largely retired "guardrails" in favour of named practices — and its two tiers (foundations guidance for organisations starting out; implementation guidance for complex or higher-risk use) are deliberately sized so that a smaller organisation is not asked to run an enterprise program. The separately _proposed_ mandatory guardrails for high-risk AI were never enacted: the December 2025 National AI Plan set them aside in favour of existing laws and sector regulators, and the Department of Industry, Science and Resources still states it "will not proceed at this time" with them.

A separate legislative workstream is now under way, and it is easy to mistake for the guardrails returning. On 15 July 2026 the government established an [Office of AI](https://www.pmc.gov.au/domestic-policy/office-ai) within the Department of the Prime Minister and Cabinet and announced it would legislate [Australian Standards for AI](https://www.pm.gov.au/media/ai-australias-interests). National Cabinet endorsed the approach on 26 August 2026, with legislation expected in early 2027. Read what those standards cover before assuming they cover you: obligations on large data centres for energy, water and grid connection, and copyright protection for Australian creative works used to train AI. They do not reinstate the high-risk AI guardrails, and they do not regulate how an organisation uses AI in its own operations.

If a consultant or vendor cites "the ten guardrails" as current Australian guidance, that is itself a currency test they have just failed. If they cite the Australian Standards for AI as the high-risk regime arriving, that is a second one.
