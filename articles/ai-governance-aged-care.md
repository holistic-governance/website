...
- There is no AI-specific statute for aged care — but your existing obligations under the Aged Care Act 2024, the Strengthened Quality Standards and the Privacy Act 1988 already apply to everything AI touches.
- Responsible persons cannot exercise due diligence under section 180 over tools they do not know exist. An AI inventory is the non-negotiable first step.
- Not all AI uses carry equal risk. A rostering suggestion and a tool that influences clinical care decisions should not be governed the same way — risk-tier each use.
- Clinical AI is not a new governance domain; it is an extension of your existing clinical governance framework, with human oversight and escalation pathways.
- AI governance is only real when it reaches the board: an inventory, a risk position and monitoring results, reported on a regular cadence.
...
- **Documentation and scribing** — AI assistants that draft progress notes, summaries or correspondence from voice or text.
- **Workforce and rostering** — optimisation features inside scheduling systems.
- **Consumer-facing chatbots** — answering enquiries from prospective residents and families.
- **Embedded features** — AI capabilities switched on by vendors inside care management, HR or finance software during routine updates, sometimes without a decision on your side of the fence.
- **General-purpose tools** — staff using public AI assistants for drafting, translation or summarising, with or without permission.
...
**6 — Put vendors through due diligence.** Ask where data goes, whether it is used for training, where it is stored, what happens on termination, how the model is updated, and how the vendor tells you when capability changes. A vendor's willingness to answer transparently is itself a signal — the same lesson the ASD draws about [technology vendors generally](https://hg-au.com/articles/asd-post-quantum-vendor-questions.html). Build the questions into procurement and contract renewal as standing items, not one-off projects.
...
Holistic Governance provides [AI governance advisory, independent vendor assessment and AI training](https://hg-au.com/ai-technology.html) — and for clinical settings, extends your existing [clinical governance framework](https://hg-au.com/healthcare.html) to cover AI, rather than bolting on a parallel structure. You can read more about our approach and experience [here](https://hg-au.com/about.html).

## Sources

- Aged Care Act 2024 (Cth) — provider duty (s 179) and responsible person due diligence duty (s 180). [legislation.gov.au](https://www.legislation.gov.au/C2024A00104/latest/text)
- Strengthened Aged Care Quality Standards — [Aged Care Quality and Safety Commission](https://www.agedcarequality.gov.au/strengthened-quality-standards)
- Privacy Act 1988 (Cth) and the Australian Privacy Principles — [OAIC](https://www.oaic.gov.au/privacy/australian-privacy-principles)
- Australia's AI Ethics Principles — [Department of Industry, Science and Resources](https://www.industry.gov.au/publications/australias-artificial-intelligence-ethics-principles)
- ISO/IEC 42001 — Artificial intelligence management systems — [ISO](https://www.iso.org/standard/42001)
...
- Regulation of software-based medical devices — [Therapeutic Goods Administration](https://www.tga.gov.au/how-we-regulate/manufacturing/manufacture-medical-device/manufacture-specific-types-medical-devices/regulation-software-based-medical-devices)

_This article is published by Holistic Governance for sector information purposes only. It reflects the position as at the date of issue and does not constitute legal, regulatory, audit or financial advice. Verify any specific provision on the Federal Register of Legislation (legislation.gov.au) and current regulator guidance before relying on it. © Holistic Governance 2026._
