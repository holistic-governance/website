...
topics: acqs-accreditation-audit
---

The NDIS Quality and Safeguards Commission has issued its first lifetime banning orders against a consultant and an auditor alleged to have colluded to register more than 200 providers on false or misleading information. On the back of the investigation, the Commission [refused 195 registration applications and revoked a further 40](https://www.noticer.news/ndis-lifetime-bans-consultant-auditor/). These are the first banning orders of their kind, because the power behind them is new.

**What changed, and when.** The [banning orders were made on 17 June 2026](https://www.ndiscommission.gov.au/node/1963244), permanent and nationwide, and they are the first issued under [new powers to ban auditors and consultants](https://alloranews.com/australia/ndis-issues-first-lifetime-bans-under-expanded-watchdog-powers/). Until the [National Disability Insurance Scheme Amendment (Integrity and Safeguarding) Act 2026](https://www.legislation.gov.au/C2026A00041) (assented 8 April 2026), the Commission could ban only _providers_ and _workers_. Closing that gap is the single most significant change here; the power itself, not the two individuals, is the story.
...
Follow the money, because it explains the rest. NDIS registration is free, but a provider cannot register without passing an audit, and it must find, choose and pay the auditor itself. The Commission does not assign the auditor and does not set the price. Providers are [told to get quotes and compare](https://www.ndiscommission.gov.au/provider-registration/apply-registration/types-audits), and the [commercial relationship runs directly between the provider and the auditor it hires](https://www.providerplus.com.au/post/how-much-does-ndis-provider-registration-cost-in-2026).
...
Auditors do not appoint themselves. They are accredited by [JAS-ANZ](https://www.jas-anz.org/national-disability-insurance-scheme-approved-quality-auditors-scheme) (which runs the scheme on the Commission's behalf, monitors auditors, and holds them to the [NDIS auditor guidelines and Code of Conduct](https://www.ndiscommission.gov.au/provider-registration/apply-registration/information-quality-auditors)), and then approved by the Commission itself. Two keys. Accreditation runs under the [NDIS (Approved Quality Auditors Scheme) Guidelines 2018](https://www.legislation.gov.au/F2018N00114/2020-01-01), which invoke ISO/IEC 17065:2012, the international standard whose entire purpose is the impartiality and independence of certification bodies.
...
And it was not the first warning. The sector has [already seen an approved quality auditor sanctioned](https://vccg.com.au/ndis-auditor-selection-vetting-checklist/) for selling consultancy to the very providers it was auditing: the exact conflict, in plain sight, inside an accredited body. One case is an outlier. A second, on the back of a 200-provider collusion, looks less like bad luck and more like a pattern the design invites.

## Failed, or never tested?

So the question is blunt: did the impartiality controls fail, or were they never really exercised?

- If they **failed** (conflicts declared and waved through, technical review a formality), the accountability belongs at the certification-body level, not only with two banned individuals.
- If they were **never tested**, because the framework assumes good faith and never looks at who advised the provider before the audit, then it is not a safeguard. It is paperwork.

Either way, banning two people treats the symptom. The cause is a registration gate that lets the assessed party choose and pay its own assessor, policed by an accreditation layer that only moved once the damage was done. And there is no scale excuse. Just [seventeen certification bodies](https://www.ndiscommission.gov.au/provider-registration/apply-registration/find-auditor) audit the entire NDIS market at the time of writing, and the Commission is [not currently accepting new applications](https://www.ndiscommission.gov.au/provider-registration/apply-registration/information-quality-auditors) to join them, approvals paused amid the integrity reforms now reshaping the scheme. A closed pool of seventeen makes the oversight question answerable, not impossible.
...
- The Noticer: [NDIS bans two people for life and cracks down on providers](https://www.noticer.news/ndis-lifetime-bans-consultant-auditor/)
- NDIS Quality and Safeguards Commission: banning-order records for the [consultant](https://www.ndiscommission.gov.au/node/1963244) and the [auditor](https://www.ndiscommission.gov.au/node/1963245)
- Federal Register of Legislation: [National Disability Insurance Scheme Amendment (Integrity and Safeguarding) Act 2026](https://www.legislation.gov.au/C2026A00041) (No. 41 of 2026; assent 8 April 2026)
- Allora News: [NDIS issues first lifetime bans under expanded watchdog powers](https://alloranews.com/australia/ndis-issues-first-lifetime-bans-under-expanded-watchdog-powers/)
- NDIS Quality and Safeguards Commission: [The quality audit process](https://www.ndiscommission.gov.au/provider-registration/apply-registration/types-audits), [Information for quality auditors](https://www.ndiscommission.gov.au/provider-registration/apply-registration/information-quality-auditors) (new applications paused), and [Find an auditor](https://www.ndiscommission.gov.au/provider-registration/apply-registration/find-auditor) (17 approved bodies, current to 31 July 2026)
- Provider cost guidance: [how much it costs to become an NDIS provider (2026)](https://www.providerplus.com.au/post/how-much-does-ndis-provider-registration-cost-in-2026)
...
- JAS-ANZ: [National Disability Insurance Scheme (Approved Quality Auditors Scheme)](https://www.jas-anz.org/national-disability-insurance-scheme-approved-quality-auditors-scheme)
- VCCG: [NDIS auditor selection: vetting checklist](https://vccg.com.au/ndis-auditor-selection-vetting-checklist/)
- Aged Care Quality and Safety Commission: [Assessors](https://www.agedcarequality.gov.au/about-us/assessors)

_Holistic Governance provides governance and compliance decision support for the aged care and disability sectors. This article is general commentary, not legal advice._
