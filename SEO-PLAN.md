...
- [ ] After deploy: Request Indexing for `/aged-care-board-reporting.html`, `/` (homepage), `/board-reporting-health-check.html` (newly added to sitemap), and the two updated articles. ✳ IndexNow ping for these URLs submitted 2026-07-26 — HTTP 200.
- [ ] **2026-07-26 (AI/tech push):** Request Indexing for `/ai-technology.html`, `/app-development.html`, `/articles/ai-governance-aged-care.html` (new — content calendar #4), `/reporting-dashboards.html`, `/resources.html`, and updated articles `/articles/asd-post-quantum-vendor-questions.html` + `/articles/data-quality-foundation-of-ai.html`. Remember the ~10–12/day rate limit — spread across two days with the board-reporting batch.
